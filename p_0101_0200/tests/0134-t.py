...
def run(sln):
    ...
    test_solution(sln, [1, 2, 3, 4, 5, 1, 8], [3, 4, 5, 1, 2, 8, 1], 6)    
    test_solution(sln, [2, 3, 4], [3, 4, 3], -1)
    test_solution(sln, [4, 5, 3, 1, 4], [5, 4, 3, 4, 2], -1)
    test_solution(sln, [0, 0, 0, 0, 2], [0, 0, 0, 1, 0], 4)
    test_solution(sln, [0, 0, 2, 0, 2], [0, 0, -2, 0, 0], 0)
    test_solution(sln, [2, 2, 2, 2, 2], [-2, -2, -2, -2, 0], 0)
    test_solution(sln, [5, 8, 2, 8], [6, 5, 6, 6], 3)
